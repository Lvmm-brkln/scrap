...
def get_the_email_of_a_townhall_from_its_webpage(arg)
	document_mairie = open(arg)
...
def get_all_the_urls_of_val_doise_townhalls(arg2)
	document_mairies = open(arg2)
